...
const AdminSeo = () => {
  ...
  return (
    <div>
      <div class=" ">
        <h1 class="text-4xl font-bold capitalize text-gray-900 leading-tight mb-2 border-b-2 border-gray-500 pb-2 px-6">
          Add seo
        </h1>
      </div>
      <form
      ...
      >
        ...
        <div className="mb-1  w-full  mr-0 md:mr-2">
          ...
          <select
            ...
            className="bg-[#F0FDF4] text-gray-900 text-sm rounded-lg focus:outline-none  block w-full p-2.5 focus:border-none capitalize"
            name="page"
            id=""
          >
            ...
            <option value="our_product_page">Our Products</option>
            <option value="news_page">News Page</option>
            <option value="media_page">Media Page</option>
            <option value="shasthokotha_page">Renix Shasthokotha</option>
            <option value="shasthokothar_barta_page">
