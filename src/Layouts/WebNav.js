    ...
    return (
        ...
        <header>
            ...
            >
                ...
                <Link to={"/appoinments"}><button className='hidden lg:flex items-center px-2  py-2 rounded text-white border bg-primary border-primary text-base'>Appoinments +</button></Link>
