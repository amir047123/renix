...
const Blogs = () => {
 ...
 {/* Cartegory */}
      <div className='  p-1 ' >
        ...
        <div className=' pl-6 sm:pb-10' >

          <h1 className='text-primary font-bold text-4xl pb-5 sm:text-2xl'  >Cartegory</h1>
      ...
      <div>
        ...
        <div className=' pl-5' >
          <div className="lgl:grid lgl:grid-cols-4 lgl:gap-4 sm:grid sm:grid-cols-1">

            {blogs.map((blog, index) => (
              <Link to="/blogview" key={index}>
                <BlogCard  title={blog.title} description={  blog.description.substring(0,100) + "..."} image={blog.image} />
              </Link>
            ))}
