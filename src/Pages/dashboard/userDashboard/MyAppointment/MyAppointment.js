...
const MyAppointment = () => {
  ...
  useEffect(() => {
    fetch(
      ` http://renixserver.tripkori.com/api/v1/appointment/getAppointment/${userInfo?._id}`
    )
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
